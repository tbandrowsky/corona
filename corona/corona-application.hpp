	...
	public:
		...
		static std::string get_machine_id()
		{
			...
			if (type == REG_SZ || type == REG_EXPAND_SZ) {
				...
				if (utf8len == 0) return machine_id;
				machine_id.resize(static_cast<size_t>(utf8len) - 1); // exclude terminating null
				::WideCharToMultiByte(CP_UTF8, 0, wstr, -1, machine_id.data(), utf8len, nullptr, nullptr);
				return machine_id;
			}
