#define APPLICATION_CHRISTMASGAMES 1
#define APPLICATION_GUITAR 2
#define APPLICATION_ID APPLICATION_CHRISTMASGAMES



#if APPLICATION_ID == APPLICATION_CHRISTMASGAMES
#include "app_christmasgames.hpp"
#define application_function(a,b) corona::run_christmasgames_application(a,b);
#endif

#if APPLICATION_ID == APPLICATION_GUITAR
#include "app_guitar.hpp"
#define application_function(a,b) corona::run_guitar_application(a,b);
#endif
