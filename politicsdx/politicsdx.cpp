#define APPLICATION_POLITICSDX 3
#define APPLICATION_ID APPLICATION_POLITICSDX



#if APPLICATION_ID == APPLICATION_POLITICSDX
#include "app_politicsdx.hpp"
#define application_function(a,b) corona::run_politicsdx_application(a,b);
#endif
